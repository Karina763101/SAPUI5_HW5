sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("jblesson03/WorklistLesson3/app", ".html");
		...
		return Opa5.extend("jblesson03.WorklistLesson3.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["jblesson03/WorklistLesson3/localService/mockserver"], function (mockserver) {
